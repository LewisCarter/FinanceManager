...
import { SavingsTotalsPanel } from './Components/SavingsPots/savings.totals.component';
...
import { PlannedTransactionsPanel } from './Components/PlannedTransactions/planned.transaction.totals.component';
import { TransactionHistory } from './Components/TransactionHistory/transaction.history';
import { AccountNavigation } from './Components/AccountNavigation/account.navigation';
import { AccountTotal } from './Components/Total/account.total';
import { AccountTotalMinusBills } from './Components/TotalMinusBills/account.total.minus.bills';
import { AccountTotalsChart } from './Components/TotalsChart/account.total.chart';

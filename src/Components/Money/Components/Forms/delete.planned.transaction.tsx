import { deletePlannedTransaction } from '../../../../DAOs/Money/planned.transaction.dao';
import { IPlannedTransaction } from '../../../../DTOs/Money/planned.transaction.dto';

export const DeletePlannedTransaction = (props: {
	...
	function del() {
		deletePlannedTransaction(props.plannedTransaction.id).then((id: string) => {
			if (id !== null) {

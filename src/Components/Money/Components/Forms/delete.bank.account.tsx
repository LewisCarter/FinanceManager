...
class DeleteAccount extends React.Component<IDeleteAccountProps, IDeleteAccountState> {
	...
	async delete() {
		const deleted = await deleteAccount(this.props.account.id);
	...
	render() {
		return <>
			...
			<div className="flex flex-row">
				<button type="button" className="bg-red-600 hover:bg-red-700 rounded-md pt-2 pr-3 pb-2 pl-3 text-white flex flex-row mr-5" onClick={this.cancel}>
				...
				<button type="button" className="bg-green-600 hover:bg-green-700 self-end rounded-md pt-2 pr-3 pb-2 pl-3 text-white flex flex-row" onClick={this.delete}>
